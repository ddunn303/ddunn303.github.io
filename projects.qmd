...
### Water Rights and Notice Review Databases
Currently I am working on developing and expanding the National Park Service's documentation and ability to track, analyze, and manage their water rights. This includes creating an inventory of all water rights owned by the National Park Service and of water rights owned by others within the boundaries of National Park units. This data is being gathered from existing State resources and existing National Park files to be uploaded into a central, modern, and user friendly database hosted in ArcGIS Online and Sharepoint, and managed through through curated Experiences and Forms. Already this information is being used to assess current water supply issues at several park units, study the need for flow protection in Grand Teton National Park, and to review new water right filings across the Western U.S.

::: {.flex gap=4}
![](images/tetoncounty_exp.png){width=100%}
...
```{r, echo=FALSE}
knitr::include_graphics('images/ws_well.jpg')
```
